        ...
        <?php if ($this->ion_auth->in_group(array('admin', 's_admin'))) { ?>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-br-primary rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                <i class="fa fa-dollar tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Total Amount</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1"> <?php echo $all_pay_add - $all_pay_cut; ?> /-  </p>
                  <span class="tx-11 tx-roboto tx-white-6"> Advance in our account </span>
                </div>
              </div>
            </div>
          </div>
