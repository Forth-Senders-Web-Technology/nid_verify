<body>
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="br-mainpanel br-profile-page" style="margin:0;">
      ...
      <div class="card shadow-base bd-0 rounded-0 widget-4">
        ...
        <div class="card-body">
          ...
          <h4 class="tx-normal tx-roboto tx-white"><?php echo $setting_info->name_s; ?></h4>
          <p class="mg-b-25">
              <!-- Title Here -->
          </p>
      ...
      <div class="ht-70 bg-gray-100 pd-x-20 d-flex align-items-center justify-content-center shadow-base">
        <ul class="nav nav-outline active-info align-items-center flex-row" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="reg_form" > Registration </a></li>
          <li class="nav-item hidden-xs-down"><a class="nav-link" href="login" > Login </a></li>
        </ul>
      </div>
