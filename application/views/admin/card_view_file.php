...
<body>
    <div class="" style=" width: 332px; margin: 0px 6.38px 0 20px; float: left;">
        <div class="" style="margin: 0; padding: 0; border: 1.5px solid black; width: 320px;  height: 205px;">
            <img src="inc/card_img/bd_logo_0.jpg" width="37px" height="35px" alt="" style="margin: 8px 0 0 5px; float: left;">
            <p style=" margin: 3px 0 0 0px; font-size: 17px; text-align: center; font-family: 'SolaimanLipi', sans-serif;">
            ...
            <div class="" style=" width:72px; margin: 0; padding: 0; float: left; ">
                <img width="68px" height="77px" src="inc/bar_code/man.png" alt="" style=" margin: 2px 2px 2px 2px; padding: 0;"><br>
                <img width="68px" height="13px" src="inc/bar_code/sign.jpg" alt="" style="margin: 5px 2px 2px 2px; padding: 0;">
            </div>
            <div style=" width: 245px; float: left; margin: 2px 0 0 0; background:url('inc/card_img/back.jpg'); background-repeat: no-repeat; background-size: 680px 380px; background-position: 5px 0px;" class="">
                ...
                <div style="margin-top: 0px;">
                    <div style="font-family: SolaimanLipi; font-size: 12px; float: left; margin:  4px 0 0 9px ;">Date of Birth:
                        <span style="color: #FF0000; font-weight: bolder;">28 Jul 1988</span>
                    </div>
                    <div style="font-family: SolaimanLipi; font-size: 13px; float: left; margin: 2px 0 0 9px ;">ID NO: <span
                            style="color: #FF0000; font-weight: bold; font-size: 12px; ">1052884596</span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="" style="margin: 0px 6.38px 0 0px; float: left; width: 322px;">
        <div class="" style="margin: 0; padding: 0; border: 1.5px solid black; width: 320px;  height: 205px;">
            ...
            <div class="" style=" width: 30px; font-family: SolaimanLipi; font-size: 9.5px; margin: 1px 0px 6px 7px; float: left;">
                ঠিকানা:
            </div>
            <div style="font-family: SolaimanLipi; font-size: 9.5px; margin: 1px 3px 20px 2px;"> 
                বাসা/হোল্ডিং: আনু মোল্লা বাড়ী, গ্রাম/রাস্তা: কালাম্পাড়া, ডাকঘর: বানু সওঃ বাড়ি - ২৩৫০, হাবিলদার এলাকা, কক্সবাজার 
            </div>

            <div class="" style=" width: 130px; font-family: SolaimanLipi; font-size: 9.5px; margin: 5px 0px 0px 4px; float: left; ">
                রক্তের গ্রুপ /
            ...
            <div style="font-family: SolaimanLipi; font-size: 8.8px; color: white; background-color: #000000; width: 35px; margin: 0; float: right; padding: 0 1px 1px 0; ">
                মূদ্রণ: ০১</div>
            ...
            <div>
                <img style="margin: 2px 0 0 20px;" src="inc/bar_code/ec_sign0.jpg" width="70px" height="32px"
                    alt=""><br>
                <div style="font-family: SolaimanLipi; width: 160px ; font-size: 11px; margin: -4px 0 0px 7px; float: left; " class="">
                    প্রদানকারী কর্তৃপক্ষের স্বাক্ষর 
                </div>
                <div style="font-family: SolaimanLipi; font-size: 10px; margin: 2px 0px 0px 5px; float: right;"
                    class="">
                    প্রদানের তারিখ: 
                <span style="font-family: SolaimanLipi;">১৫/০৩/২০২১</span></div>
            </div>
